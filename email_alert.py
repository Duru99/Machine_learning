...
def send_email(image_name, predicted_class):
    ...
    if predicted_class in ['Angry', 'Disgust', 'Fear', 'Sad']:
        body = 'The person facial expression seems to bad. They may need medical assistance.'
    elif predicted_class in ['Happy', 'Neutral', 'Surprise']:
        body = 'The person facial expression seems to be good. They may not need medical assistance.'
    else:
